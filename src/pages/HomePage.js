...
const HomePage = () => {
  ...
  if(catchall && catchall.startsWith('@')) {
    params.username = catchall.substring(1)
  }
    ...
    <div id="home-page">
      {/* {showPopup && (
        <div className="popup" ref={popupRef}>
          <p>Your vote shapes pin's journey.<br />Support the WorldMappin <a href="https://peakd.com/proposals/313" target="_blank" rel="noreferrer">proposal</a>, every bit helps! ❤️</p>
          <a href="https://peakd.com/proposals/313" target="_blank" rel="noreferrer" className="vote-btn">Vote now!</a>
